...
public:
  ...
  void setOnEmojiSelected(std::function<void(const std::string&)> callback) {
  ...
  std::unordered_set<std::string> getVisibleTwemojisInChat(const std::vector<Discord::Message>& messages, float scrollY, float totalH);
